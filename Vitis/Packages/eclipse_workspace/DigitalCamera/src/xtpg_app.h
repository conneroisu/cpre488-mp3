...
/*****************************************************************************
 * xtpg_app.h - Customized macros and routines for the TPG test
...
#define XTPG_SLV_REG10_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000028)
#define XTPG_SLV_REG11_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000002C)
#define XTPG_SLV_REG12_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000030)
#define XTPG_SLV_REG13_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000034)
#define XTPG_SLV_REG14_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000038)
#define XTPG_SLV_REG15_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000003C)
#define XTPG_SLV_REG16_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000040)
#define XTPG_SLV_REG17_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000044)
#define XTPG_SLV_REG18_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000048)
#define XTPG_SLV_REG19_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000004C)
#define XTPG_SLV_REG20_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000050)
#define XTPG_SLV_REG21_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000054)
#define XTPG_SLV_REG22_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000058)
#define XTPG_SLV_REG23_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000005C)
#define XTPG_SLV_REG24_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000060)
#define XTPG_SLV_REG25_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000064)
#define XTPG_SLV_REG26_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000068)
#define XTPG_SLV_REG27_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000006C)
#define XTPG_SLV_REG28_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000070)
#define XTPG_SLV_REG29_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000074)
#define XTPG_SLV_REG30_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000078)
#define XTPG_SLV_REG31_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x0000007C)
#define XTPG_SLV_REG32_OFFSET                                        \
  (XTPG_USER_SLV_SPACE_OFFSET + 0x00000080)
 ...
 * -- INTR_DIIR  : device (peripheral) interrupt id (priority encoder)
 * register
 * -- INTR_DGIER : device (peripheral) global interrupt enable
 * register
...
#define XTPG_INTR_DISR_OFFSET                                        \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000000)
#define XTPG_INTR_DIPR_OFFSET                                        \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000004)
#define XTPG_INTR_DIER_OFFSET                                        \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000008)
#define XTPG_INTR_DIIR_OFFSET                                        \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000018)
#define XTPG_INTR_DGIER_OFFSET                                       \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x0000001C)
#define XTPG_INTR_IPISR_OFFSET                                       \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000020)
#define XTPG_INTR_IPIER_OFFSET                                       \
  (XTPG_INTR_CNTRL_SPACE_OFFSET + 0x00000028)
 ...
 * @note
 * C-style signature:
 *  void XTPG_mWriteReg(Xuint32 BaseAddress, unsigned RegOffset,
 * Xuint32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 *  void XTPG_mWriteSlaveRegn(Xuint32 BaseAddress, unsigned RegOffset,
 * Xuint32 Value) Xuint32 XTPG_mReadSlaveRegn(Xuint32 BaseAddress,
 * unsigned RegOffset)
 *
 */
...
/**
 *
 * Run a self-test on the driver/device. Note this may be a
 * destructive test if resets of the device are performed.
 *
 * If the hardware system is not built correctly, this function may
 * never return to the caller.
 *
 * @param   baseaddr_p is the base address of the XTPG instance to be
 * worked on.
 *
 * @return
 *
