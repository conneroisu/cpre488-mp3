/*****************************************************************************
 * xtpg_app.c - Customized macros and routines for the TPG test
 *pattern generator module.
 *****************************************************************************/

// !!! UNDER CONSTRUCTION: Only use as a high-level structural
// reference !!!
...
void xTPG_main(int width, int height, int TPG_BASEADDR) {
  ...
  Xuint32 Reg32Value;
  Xuint32 NewXHairHCoord, NewXHairVCoord, CompMaskValue, CrCbPolarity,
      NewBoxComponentVal, NewBoxSize, CurrentPattern,
      CurrentBoxColourPreset, CurrentSpeed, CurrentSPVal,
      CurrentNoiseGain, CurrentThrottleIndex;
  ...
  XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                       (Reg32Value & 0xFFFFFFF0) | 10);
  ...
  CurrentSpeed = 4;
  XTPG_mWriteSlaveReg1(TPG_BASEADDR, 0,
                       (CurrentSpeed << 1) |
                           (Reg32Value & 0x00000001));
  ...
  while (1) {
    ...
    case 'r': {
      ...
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 0  (offset 0x0000) "
                 "(PatternSel)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg1(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 1  (offset 0x0004) "
                 "(Motion)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg2(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 2  (offset 0x0008) "
                 "(XHairs)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg3(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 3  (offset 0x000C) "
                 "(FrameSize)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg4(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 4  (offset 0x0010) "
                 "(HSweep register)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg5(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 5  (offset 0x0014) "
                 "(VSweep register)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg6(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 6  (offset 0x0018) "
                 "(Box Size)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg7(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 7  (offset 0x001C) "
                 "(Box Colour)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg8(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 8  (offset 0x0020) "
                 "(Stuck-Pixel frequency index)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg9(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 9  (offset 0x0024) "
                 "(Noise Gain)\n\r",
                 Reg32Value);
      Reg32Value = XTPG_mReadSlaveReg10(TPG_BASEADDR, 0);
      xil_printf("   Read 0x%08x from register 10 (offset 0x0028) "
                 "(Throttle level)\n\r",
                 Reg32Value);
      break;
    }
    case '0': // Video Passthrough
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFFFFFFF0) | 0x00000000);
      break;
    }
    case '1': // HRamp
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFF0) | 0x00000001));
      break;
    }
    case '2': // VRamp
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFF0) | 0x00000002));
      break;
    }
    case '3': // TRamp
    {
      ...
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFF0) | 0x00000003));
      break;
    }
    ...
    case '4': // Rotate full frame colours R G B Black White
    {
      ...
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFFFFFFD0) |
                               CurrentPattern);
      break;
    }

    case '5': // Rotate preset box colours White Yellow Cyan Green
    ...
    case '9': // Colour bars
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFD0) | 0x00000009));
      break;
    }
    case 'T': // Tartan Bars
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFF0) | 0x0000000b));
      break;
    }
    ...
    case 'X': // Crosshatch
    {
      Reg32Value = XTPG_mReadSlaveReg0(TPG_BASEADDR, 0);
      XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                           ((Reg32Value & 0xFFFFFFF0) | 0x0000000c));
      break;
    }
    ...
    case 'S': // Stuck-Pixel emulator
    {
      ...
      if ((Reg32Value & 0x00004000) >> 14 == 0) {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00004000);
        xil_printf("Stuck-pixel emulator ON\r\n");
      } else {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFFBFFF);
    ...
    case '=': // Enable AXI bypass
    {
      ...
      if ((Reg32Value & 0x00040000) == 0x00040000) {
        ...
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFBFFFF);
      } else {
        xil_printf("Enabling AXI Bypass.\n\r");
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00040000);
      }
      break;
    }
    ...
    case '}': // Data Throttle on/off
    {
      ...
      if ((Reg32Value & 0x00020000) >> 17 == 0) {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00020000);
        xil_printf("Data Throttle ON\r\n");
      } else {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFDFFFF);
    ...
    case 'N': // Noise generator
    {
      ...
      if ((Reg32Value & 0x00008000) >> 15 == 0) {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00008000);
        xil_printf("Noise generator ON\r\n");
      } else {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFF7FFF);
    ...
    case 'H': // Invert HSync
    {
      ...
      if (((Reg32Value & 0x00000800) >> 11) == 0)
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value | 0x00000800));
      else
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value & 0xFFFFF7FF));
      break;
    }
    ...
    case 'V': // Invert VSync
    {
      ...
      if (((Reg32Value & 0x00000400) >> 10) == 0)
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value | 0x00000400));
      else
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value & 0xFFFFFBFF));
      break;
    }
    ...
    case 'h': // Horizontal Sweep
    {
      if (ENABLE_ZONEPLATE_AND_SWEEPS == 1) {
        ...
        XTPG_mWriteSlaveReg5(
            TPG_BASEADDR, 0,
            0); // Zoneplate with 0 vertical component
      }
      break;
    }
    ...
    case 'v': // Vertical Sweep
    {
      if (ENABLE_ZONEPLATE_AND_SWEEPS == 1) {
        ...
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value & 0xFFFFFFF0) | 10);
        XTPG_mWriteSlaveReg4(
            TPG_BASEADDR, 0,
            0); // Zoneplate with 0 horizontal component
    ...
    case 'z': // Zone-Plate
    {
      if (ENABLE_ZONEPLATE_AND_SWEEPS == 1) {
        ...
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             (Reg32Value & 0xFFFFFFF0) | 10);
        ZPlate_config(width, height, TPG_BASEADDR);
        //               XTPG_mWriteSlaveReg4(TPG_BASEADDR, 0,
        //               ((1<<5)*SinTableDepth)*2/width);
        //               XTPG_mWriteSlaveReg5(TPG_BASEADDR, 0,
        //               ((1<<5)*SinTableDepth)*2/height);
      }
      break;
    }
    ...
    case 'x': // Crosshairs
    {
      ...
      if ((Reg32Value & 0x00000010) >> 4 == 0)
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00000010);
      else
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFFFFEF);
      break;
    }
    case 'p': // Horizontal Crosshair - decrease V coordinate
    {
      ...
      XTPG_mWriteSlaveReg2(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFFFF0000) |
                               NewXHairVCoord);
      xil_printf("New XHair: (%d, %d)\n\r",
                 (Reg32Value >> 16 & 0x0000FFFF), NewXHairVCoord);
      break;
    }
    ...
    case 'a': // Vertical Crosshair - decrease H coordinate
    {
      Reg32Value = XTPG_mReadSlaveReg2(TPG_BASEADDR, 0);
      NewXHairHCoord =
          (((Reg32Value >> 16) & 0x0000FFFF) - 1) & 0x0000FFFF;
      XTPG_mWriteSlaveReg2(TPG_BASEADDR, 0,
                           (Reg32Value & 0x0000FFFF) | NewXHairHCoord
                                                           << 16);
      xil_printf("New XHair: (%d, %d)\n\r", NewXHairHCoord,
                 (Reg32Value & 0x0000FFFF));
      break;
    }
    ...
    case 'i': // Invert CbCr
    {
      ...
      if ((Reg32Value & 0x00000020) >> 5 == 0) {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00000020);
        CrCbPolarity = 1;
      } else {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xFFFFFFDF);
        CrCbPolarity = 0;
      }
    ...
    case 'B': // Box on/off
    {
      ...
      if ((Reg32Value & 0x00000200) >> 6 == 0) {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value | 0x00000200);
        xil_printf("   Switching box on.\r\n");
      } else {
        XTPG_mWriteSlaveReg0(TPG_BASEADDR, 0,
                             Reg32Value & 0xfffffdff);
    ...
    case '~': // Box Colour - decrease B/Cr value
    {
      Reg32Value = XTPG_mReadSlaveReg7(TPG_BASEADDR, 0);
      NewBoxComponentVal =
          (((Reg32Value & 0x00FF0000) >> 16) - 1) & 0x000000FF;
      xil_printf("   New Box R/Y value: 0x%x\r\n",
                 NewBoxComponentVal);
      XTPG_mWriteSlaveReg7(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFF00FFFF) |
                               (NewBoxComponentVal << 16));
    ...
    case '@': // Box Colour - decrease G/Cb value
    {
      Reg32Value = XTPG_mReadSlaveReg7(TPG_BASEADDR, 0);
      NewBoxComponentVal =
          (((Reg32Value & 0x0000FF00) >> 8) - 1) & 0x000000FF;
      xil_printf("   New Box G/Cb value: 0x%x\r\n",
                 NewBoxComponentVal);
      XTPG_mWriteSlaveReg7(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFFFF00FF) |
                               (NewBoxComponentVal << 8));
      break;
    }
    ...
    case '$': // Box Colour - decrease R/Y value
    {
      Reg32Value = XTPG_mReadSlaveReg7(TPG_BASEADDR, 0);
      NewBoxComponentVal =
          ((Reg32Value & 0x000000FF) - 1) & 0x000000FF;
      xil_printf("   New Box B/Cr value: 0x%x\r\n",
                 NewBoxComponentVal);
      XTPG_mWriteSlaveReg7(TPG_BASEADDR, 0,
                           (Reg32Value & 0xFFFFFF00) |
                               NewBoxComponentVal);
      break;
    }
...
void xTPG_help(void) {
  ...
  print(" 3 = Temporal Ramp (please switch motion ('m') on for "
        "T-Ramp)\n\r");
  ...
  if (ENABLE_ZONEPLATE_AND_SWEEPS == 1) {
    ...
    print("    H and V frequency controls for H/V sweeps apply to "
          "zone-plate. \n\r");
  }
  print(" m = Motion on/off\n\r");
  print("    n = Decrease Motion Speed\n\r");
  print("    , = Increase Motion Speed\n\r");
  print(" . = Increment Component Mask (0 = mask off; 7 = mask all 3 "
        "components)\n\r");
  ...
  print(" } = Data-throttle on/off (for AXI-Stream "
        "stress-testing)\n\r");
  print("    { = Decrease throttle index.\n\r");
  print("    | = Increase throttle index.\n\r");
  print(
      " + = Disable Input AXI interface (so TPG ignores TValid)\n\r");
  print(" B = Enable Box overlay.\n\r");
  print("    B = Enable Box overlay.\n\r");
  print("    &, ^ = Increase, decrease Box Size\n\r");
  print("    %, $ = Increase, decrease Box R, Y component value\n\r");
  print(
      "    #, @ = Increase, decrease Box G, Cb component value\n\r");
  print(
      "    !, ~ = Increase, decrease Box B, Cr component value\n\r");
...
void xTPG_config(int width, int height, int TPG_BASEADDR, int reset) {
  ...
  XTPG_mWriteSlaveReg3(
      TPG_BASEADDR, 0,
      FrameSize); // Frame size set according to parameter
  ZPlate_config(width, height, TPG_BASEADDR);
  ...
  if (reset == 0) {
    ...
    XTPG_mWriteSlaveReg2(TPG_BASEADDR, 0,
                         (573 << 16) |
                             360); // XHairs set at (573H, 360V)
    XTPG_mWriteSlaveReg4(TPG_BASEADDR, 0,
                         1); // Set zone plate HDelta2 to 1 (bits
                             // 11:0) Set zone plate H sin-table
                             // address offset to 0 (bits 27:16)
    XTPG_mWriteSlaveReg5(TPG_BASEADDR, 0,
                         1); // Set zone plate VDelta2 to 1 (bits
                             // 11:0) Set zone plate V sin-table
                             // address offset to 0 (bits 27:16)
    XTPG_mWriteSlaveReg7(TPG_BASEADDR, 0,
                         0x005AF051); // Set box colour to mid blue
    XTPG_mWriteSlaveReg8(TPG_BASEADDR, 0,
                         0); // Set Stuck-Pixel frequency index to 0
    XTPG_mWriteSlaveReg9(TPG_BASEADDR, 0,
                         0); // Set Noise level index to 0
    XTPG_mWriteSlaveReg10(TPG_BASEADDR, 0,
                          0); // Set Throttle level to 0
  }
}
