...
int vfb_common_init(u16 uDeviceId, XAxiVdma *pAxiVdma) {
  ...
  XScuGic_SetPriorityTriggerType(
      &int_controller, XPAR_FABRIC_AXIVDMA_0_S2MM_INTROUT_VEC_ID,
      0xA0, 0x3);
  XScuGic_SetPriorityTriggerType(
      &int_controller, XPAR_FABRIC_AXIVDMA_0_MM2S_INTROUT_VEC_ID,
      0xA0, 0x3);
  ...
  XScuGic_Enable(&int_controller,
                 XPAR_FABRIC_AXIVDMA_0_MM2S_INTROUT_VEC_ID);
  XScuGic_Enable(&int_controller,
                 XPAR_FABRIC_AXIVDMA_0_S2MM_INTROUT_VEC_ID);
