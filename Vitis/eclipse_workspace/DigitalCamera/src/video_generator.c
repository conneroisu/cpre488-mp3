...
/*****************************************************************************
 * video_generator.c - configuration functions for the VTC video
 *timing controller. Configures a VTC to generate timing at the
 *specified frequency. Mostly redundant functionality with
 *video_detector.c
 *
 *
 * NOTES:
...
/**
 *
 * This function sets up the Video Timing Controller Signal
 *configuration.
 *
 * @param	None.
 *
...
static void SignalSetup(XVtc *pVtc,
  ...
  //	SignalCfgPtr->HActiveStart = HFrontPorch + HSyncWidth +
  //HBackPorch;
  //
  ...
  //	SignalCfgPtr->V0ChromaStart = VFrontPorch + VSyncWidth +
  //VBackPorch; 	SignalCfgPtr->V0ActiveStart = VFrontPorch + VSyncWidth
  //+ VBackPorch;
 ...
 *           vVerbose = 0 no verbose, 1 minimal verbose, 2 most
 *verbose
 *
 * @return	0 if all tests pass, 1 otherwise.
 *
