 ...
 * ----- ---- --------
 *------------------------------------------------------- 1.00a ecm
 *01/10/10 Initial release 2.00a mb	25/05/12 mio init removed
...
/**
 *
 * This function initializes the controller for the NOR FLASH
 *interface.
 *
 * @param	None
 *
...
/**
 *
 * This function provides the NOR FLASH interface for the Simplified
