...
/*****************************************************************************/
/**
 * This function registers the user defined delay/sleep function with
 *subsystem
 *
 * @param  InstancePtr is a pointer to the Subsystem instance
 * @param  CallbackFunc is the function pointer to the user defined
 *delay function
 * @param  CallbackRef is the pointer to timer instance used by the
 *delay function
 *
 * @return None
 *
...
/*****************************************************************************/
/**
 * This function updates picture brighntess setting with specified
 *value
 *
 * @param  InstancePtr is a pointer to the Subsystem instance to be
 *worked on.
...
/*****************************************************************************/
/**
 * This function updates picture saturation setting with specified
 *value
 *
 * @param  InstancePtr is a pointer to the Subsystem instance to be
 *worked on.
...
/*****************************************************************************/
/**
 * This function returns picture gain setting for the specified color
 *channel
 *
 * @param  InstancePtr is a pointer to the Subsystem instance to be
 *worked on.
 ...
 ******************************************************************************/
XVidC_ColorRange
XVprocSs_GetPictureColorRange(XVprocSs *InstancePtr) {
 ...
 * Post this function call all further picture settings will apply
 *only within the defined window. Demo window gets reset everytime
 *subsystem configuration changes
 *
 * @param  InstancePtr is a pointer to the Subsystem instance to be
 *worked on.
 * @param  Win is the pointer to window coordinates within which
 *picture settings should be applied
 *
 * @return XST_SUCCESS if window is valid else XST_FAILURE
 *
 * @note   Applicable only if CSC core is included in the subsystem
 *and the Demo Window is enabled
 *
 ******************************************************************************/
 ...
 * @return None
 *
 * @note   Applicable only if Letterbox core is included in the
 *subsystem
 *
 ******************************************************************************/
 ...
 * @return None
 *
 * @note   Applicable only if Scaler cores are included in the
 *subsystem
 *
 ******************************************************************************/
 ...
 * @return None
 *
 * @note   Applicable only if Resampler cores are included in the
 *subsystem
 *
 ******************************************************************************/
...
/*****************************************************************************/
/**
 * This function reports the subsystem HW and input/output stream
 *configuration
 *
 * @param  InstancePtr is a pointer to the Subsystem instance to be
 *worked on.
