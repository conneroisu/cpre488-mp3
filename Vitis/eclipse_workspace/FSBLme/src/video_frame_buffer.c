...
#define NUMBER_OF_READ_FRAMES 5U
#define NUMBER_OF_WRITE_FRAMES 5U
...
int vfb_check_errors(XAxiVdma *pAxiVdma, u8 bClearErrors) {
	...
	if (Errors) {
		...
		*((volatile int *) (uBaseAddr + XAXIVDMA_RX_OFFSET +
		XAXIVDMA_SR_OFFSET)) = 0x0000CFF0; // XAXIVDMA_SR_ERR_ALL_MASK;
		*((volatile int *) (uBaseAddr + XAXIVDMA_TX_OFFSET +
		XAXIVDMA_SR_OFFSET)) = 0x000046F0; // XAXIVDMA_SR_ERR_ALL_MASK;
	}
