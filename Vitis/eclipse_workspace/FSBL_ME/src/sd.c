 ...
 * ----- ---- --------
 *------------------------------------------------------- 1.00a jz
 *04/28/11 Initial release 7.00a kc  10/18/13 Integrated SD/MMC driver
...
/**
 *
 * This function initializes the controller for the SD FLASH
 *interface.
 *
...
/**
 *
 * This function provides the SD FLASH interface for the Simplified
