...
//                                         - onsemi_vita_spi
//                                         - onsemi_vita_cam
//                      Feb 23, 2015: 3.1  Add core_version/core_id
//                      registers Nov 17, 2015: 3.3  Update driver
...
/**
 *
 * Write a value to a ONSEMI_VITA_SPI/CAM register. A 32 bit write is
 * performed. If the component is implemented in a smaller width, only
 * the least significant data is written.
 *
 * @param   BaseAddress is the base address of the ONSEMI_VITA_SPI/CAM
 * core.
 * @param   RegOffset is the register offset from the base to write
 * to.
 ...
 * @note
 * C-style signature:
 * 	void ONSEMI_VITA_SPI/CAM_mWriteReg(Xuint32 BaseAddress,
...
/**
 *
 * Read a value from a ONSEMI_VITA_SPI/CAM register. A 32 bit read is
 * performed. If the component is implemented in a smaller width, only
 * the least significant data is read from the register. The most
 ...
 * @note
 * C-style signature:
 * 	Xuint32 ONSEMI_VITA_SPI/CAM_mReadReg(Xuint32 BaseAddress,
 * unsigned RegOffset)
 *
 */
...
/**
 *
 * Write/Read 32 bit value to/from ONSEMI_VITA_SPI/CAM user logic
 * slave registers.
 *
 * @param   BaseAddress is the base address of the ONSEMI_VITA_SPI/CAM
 * core.
 ...
 * @note
 * C-style signature:
 * 	void ONSEMI_VITA_SPI/CAM_mWriteSlaveRegn(Xuint32 BaseAddress,
 * unsigned RegOffset, Xuint32 Value) Xuint32
 * ONSEMI_VITA_SPI/CAM_mReadSlaveRegn(Xuint32 BaseAddress, unsigned
 * RegOffset)
 *
 */

// ONSEMI_VITA_SPI definitions
#define ONSEMI_VITA_SPI_mWriteSlaveReg0(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_SPI_S00_AXI_SLV_REG0_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_SPI_mWriteSlaveReg1(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_SPI_S00_AXI_SLV_REG1_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_SPI_mWriteSlaveReg2(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_SPI_S00_AXI_SLV_REG2_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_SPI_mWriteSlaveReg3(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_SPI_S00_AXI_SLV_REG3_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
//
#define ONSEMI_VITA_SPI_mReadSlaveReg0(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_SPI_S00_AXI_SLV_REG0_OFFSET) + (RegOffset))
#define ONSEMI_VITA_SPI_mReadSlaveReg1(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_SPI_S00_AXI_SLV_REG1_OFFSET) + (RegOffset))
#define ONSEMI_VITA_SPI_mReadSlaveReg2(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_SPI_S00_AXI_SLV_REG2_OFFSET) + (RegOffset))
#define ONSEMI_VITA_SPI_mReadSlaveReg3(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_SPI_S00_AXI_SLV_REG3_OFFSET) + (RegOffset))

// ONSEMI_VITA_CAM definitions
#define ONSEMI_VITA_CAM_mWriteSlaveReg0(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG0_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg1(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG1_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg2(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG2_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg3(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG3_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg4(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG4_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg5(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG5_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg6(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG6_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg7(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_LV_REG7_OFFSET) +           \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg8(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG8_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg9(BaseAddress, RegOffset,      \
                                        Value)                       \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG9_OFFSET) +          \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg10(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG10_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg11(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG11_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg12(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG12_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg13(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG13_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg14(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG14_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg15(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG15_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg16(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG16_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg17(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG17_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg18(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG18_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg19(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG19_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg20(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG20_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg21(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG21_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg22(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG22_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg23(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG23_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg24(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG24_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg25(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG25_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg26(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG26_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg27(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG27_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg28(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG28_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg29(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG29_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg30(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG30_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
#define ONSEMI_VITA_CAM_mWriteSlaveReg31(BaseAddress, RegOffset,     \
                                         Value)                      \
  Xil_Out32((BaseAddress) +                                          \
                (ONSEMI_VITA_CAM_S00_AXI_SLV_REG31_OFFSET) +         \
                (RegOffset),                                         \
            (Xuint32)(Value))
//
#define ONSEMI_VITA_CAM_mReadSlaveReg0(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG0_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg1(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG1_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg2(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG2_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg3(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG3_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg4(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG4_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg5(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG5_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg6(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG6_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg7(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG7_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg8(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG8_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg9(BaseAddress, RegOffset)       \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG9_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg10(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG10_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg11(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG11_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg12(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG12_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg13(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG13_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg14(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG14_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg15(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG15_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg16(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG16_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg17(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG17_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg18(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG18_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg19(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG19_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg20(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG20_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg21(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG21_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg22(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG22_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg23(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG23_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg24(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG24_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg25(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG25_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg26(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG26_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg27(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG27_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg28(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG28_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg29(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG29_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg30(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG30_OFFSET) + (RegOffset))
#define ONSEMI_VITA_CAM_mReadSlaveReg31(BaseAddress, RegOffset)      \
  Xil_In32((BaseAddress) +                                           \
           (ONSEMI_VITA_CAM_S00_AXI_SLV_REG31_OFFSET) + (RegOffset))
...
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG0                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000000)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG1                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000004)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG2                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000008)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG3                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x0000000C)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG4                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000010)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG5                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000014)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG6                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x00000018)
#define ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG7                         \
  (ONSEMI_VITA_CAM_FPN_PRNU_VALUES_REG + 0x0000001C)
...
#define SENSOR_INIT_STREAMON                                         \
  103 // Start capture (corresponds to linux V4L VIDIOC_STREAMON)
