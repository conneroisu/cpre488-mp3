...
//                      Nov 14, 2011: 1.02 Add HDMI I2C config
//                      sequences
...
// #define IIC_ADV7611_INFOFRAME_ADDR   0x7C  => I2C Address conflict
// with ADV7511 (Fixed I2C Address at 0x7C)
...
#define FMC_IMAGEON_HDMI_IN_ADDR                                     \
  (IIC_ADV7611_BASE_ADDR >> 1) // 0x98/0x99 (ADV7611)
#define FMC_IMAGEON_HDMI_OUT_ADDR                                    \
  (IIC_ADV7511_BASE_ADDR >> 1)        // 0x72/0x73 (ADV7511)
...
typedef struct struct_fmc_imageon_video_timing_t
...
#define FMC_IMAGEON_I2C_SELECT_HDMI                                  \
  4 // select both HDMI_IN and HDMI_OUT
...
int fmc_imageon_hdmii_get_timing(fmc_imageon_t *pContext,
