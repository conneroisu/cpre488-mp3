...
struct struct_fmc_iic_t {
  ...
  // context data (must be large enough to contain fmc_iic_pb_t or
  // fmc_iic_axi_t)
  ...
  int (*fpIicRead)(struct struct_fmc_iic_t *,
                   Xuint8 ChipAddress,
                   Xuint8 RegAddress,
                   Xuint8 *pBuffer,
                   Xuint8 ByteCount);
  int (*fpIicWrite)(struct struct_fmc_iic_t *,
                    Xuint8 ChipAddress,
                    Xuint8 RegAddress,
                    Xuint8 *pBuffer,
                    Xuint8 ByteCount);
  int (*fpIicERead)(struct struct_fmc_iic_t *,
                    Xuint8 ChipAddress,
                    Xuint16 RegAddress,
                    Xuint8 *pBuffer,
                    Xuint8 ByteCount);
  int (*fpIicEWrite)(struct struct_fmc_iic_t *,
                     Xuint8 ChipAddress,
                     Xuint16 RegAddress,
                     Xuint8 *pBuffer,
                     Xuint8 ByteCount);
