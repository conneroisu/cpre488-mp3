...
tie %Config, 'Config', {
    archlibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl5/5.30.0/x86_64-linux',
    ...
    osvers => 'current',
    path_sep => ':',
    privlibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl5/5.30.0',
    scriptdir => 'FIXMESTAGINGDIRHOST/usr/bin',
    sitearchexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl5/site_perl/5.30.0/x86_64-linux',
    sitelibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl5/site_perl/5.30.0',
    so => 'so',
    useithreads => undef,
