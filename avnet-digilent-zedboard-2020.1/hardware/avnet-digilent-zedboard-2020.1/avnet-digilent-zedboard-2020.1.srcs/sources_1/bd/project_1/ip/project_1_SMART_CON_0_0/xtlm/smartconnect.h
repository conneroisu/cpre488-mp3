...
public:
  ...
  smartconnect(sc_module_name nm,
               xsc::common_cpp::properties &properties);

  si_socket(00) si_socket(01) si_socket(02) si_socket(03)
      si_socket(04) si_socket(05) si_socket(06) si_socket(07)
          si_socket(08) si_socket(09) si_socket(10) si_socket(11)
              si_socket(12) si_socket(13) si_socket(14) si_socket(15)

                  mi_socket(00) mi_socket(01) mi_socket(02)
                      mi_socket(03) mi_socket(04) mi_socket(05)
                          mi_socket(06) mi_socket(07) mi_socket(08)
                              mi_socket(09) mi_socket(10)
                                  mi_socket(11) mi_socket(12)
                                      mi_socket(13) mi_socket(14)
                                          mi_socket(15)
